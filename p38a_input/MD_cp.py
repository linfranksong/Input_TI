...
for line in f:
  ...
  for n in range(0,len(newlist)):
    ...
    os.chdir(wdir)
    os.system("cp /mnt/home/songlin3/Schrodinger_FEP_set/p38a_input/L%s/%s-%s_MD_NVT_rerun/* ."%(res2,i,newlist[n]))
    os.system("cp -r /mnt/home/songlin3/Schrodinger_FEP_set/p38a_input/L%s/%s-%s_MD_NVT_rerun/files/ ."%(res2,i,newlist[n]))
    #### equi
    ...
    os.system("cp /mnt/ls15/scratch/users/songlin3/run/TI_input/p38a_input/sed.sh .")
    os.system("sh sed.sh")
    os.system("rm sed.sh")
