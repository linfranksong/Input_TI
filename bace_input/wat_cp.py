...
for line in f:
  ...
  for n in range(0,len(newlist)):
    ...
    os.chdir(wdir)
    os.system("cp /mnt/home/songlin3/Schrodinger_FEP_set/bace_input/L%s/%s-%s_wat_20Abox/* ."%(res2,i,newlist[n]))
    os.system("cp -r /mnt/home/songlin3/Schrodinger_FEP_set/bace_input/L%s/%s-%s_wat_20Abox/files/ ."%(res2,i,newlist[n]))
    #### equi
    ...
    os.system("cp /mnt/ls15/scratch/users/songlin3/run/TI_input/bace_input/sed_wat.sh .")
