...
# parameter set up
dir = '/mnt/ls15/scratch/users/songlin3/run/TI_input/bace_input/'
...
for line in f:
  ...
  for n in range(0,len(newlist)):
    ...
    os.chdir(wdir)
    os.system("cp /mnt/home/songlin3/Schrodinger_FEP_set/bace_input/L%s/%s-%s_MD_NVT_rerun/* ."%(res2,i,newlist[n]))
    os.system("cp -r /mnt/home/songlin3/Schrodinger_FEP_set/bace_input/L%s/%s-%s_MD_NVT_rerun/files/ ."%(res2,i,newlist[n]))
    #### equi
    ...
    ###  heat
    os.system("cat 0.5_heat_0.in /mnt/ls15/scratch/users/songlin3/run/TI_input/bace_input/heat_gradual > 0.5_heat_0_m.in")
    os.system("cp /mnt/ls15/scratch/users/songlin3/run/TI_input/bace_input/sed.sh .")
    os.system("sh sed.sh")
    os.system("rm sed.sh")
