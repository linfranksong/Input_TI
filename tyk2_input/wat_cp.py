...
# parameter set up
dir = '/mnt/ls15/scratch/users/songlin3/run/TI_input/tyk2_input/'
...
for line in f:
  ...
  for n in range(0,len(newlist)):
    ...
    os.chdir(wdir)
    os.system("cp /mnt/home/songlin3/Schrodinger_FEP_set/tyk2_input/%s/%s-%s_wat_20Abox/* ."%(res2,i,newlist[n]))
    os.system("cp -r /mnt/home/songlin3/Schrodinger_FEP_set/tyk2_input/%s/%s-%s_wat_20Abox/files/ ."%(res2,i,newlist[n]))
    #### equi
    ...
    ###  heat
    os.system("cat 0.5_heat_0.in /mnt/ls15/scratch/users/songlin3/run/TI_input/tyk2_input/heat_gradual > 0.5_heat_0_m.in")
    os.system("cp /mnt/ls15/scratch/users/songlin3/run/TI_input/tyk2_input/sed_wat.sh .")
