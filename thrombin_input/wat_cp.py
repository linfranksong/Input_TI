...
# parameter set up
dir = '/mnt/ls15/scratch/users/songlin3/run/TI_input/thrombin_input/'
...
for line in f:
  ...
  for n in range(0,len(newlist)):
    ...
    os.chdir(wdir)
    os.system("cp /mnt/home/songlin3/Schrodinger_FEP_set/thrombin_input/%s/%s-%s_wat_20Abox/* ."%(res2,i,newlist[n]))
    os.system("cp -r /mnt/home/songlin3/Schrodinger_FEP_set/thrombin_input/%s/%s-%s_wat_20Abox/files/ ."%(res2,i,newlist[n]))
    #### equi
    ...
    ###  heat
    os.system("cat 0.5_heat_0.in /mnt/ls15/scratch/users/songlin3/run/TI_input/thrombin_input/heat_gradual > 0.5_heat_0_m.in")
    os.system("cp /mnt/ls15/scratch/users/songlin3/run/TI_input/thrombin_input/sed_wat.sh .")
    ...
    ### setpy
    os.system("cp set.py set_m.py")
    os.system("sed -i 's/equi.in/equi_m.in/g' set_m.py")
    os.system("sed -i 's/temp.pbs/temp_m.pbs/g' set_m.py")
    os.system("sed -i 's/0.5_equi_0.rst/0.5_equi_0_3.rst/g' set_m.py")
    ### pbs
    os.system("cp files/temp.pbs files/temp_m.pbs")
    os.system("sed -i 's/0.5_equi_0.rst/0.5_equi_0_3.rst/g' files/temp_m.pbs")
    os.system("sed -i 's/XXX_equi.in/XXX_equi_m.in/g' files/temp_m.pbs")
    ###equi_input
