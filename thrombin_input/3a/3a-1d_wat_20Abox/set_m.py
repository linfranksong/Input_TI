...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/3a_resp/wat_20Abox/ti_one-step/3a_1d/'
filesdir = dir + 'files/'
temp_equiin = filesdir + 'temp_equi_m.in'
temp_prodin = filesdir + 'temp_prod.in'
temp_m.pbs = filesdir + 'temp_m.pbs'
...
for j in lambd:
  ...
  os.system("cp %s %s" %(temp_m.pbs, pbs))
